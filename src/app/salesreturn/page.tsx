  ...
  <div className={`rounded-lg p-4 shadow-sm border transition-all duration-300 hover:shadow-md ${
    ...
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-2xl font-bold mt-2">{salesReturns.length}</p>
      </div>
              ...
              <tbody className="divide-y divide-gray-200">
                {currentSalesReturns.map((returnItem) => (
                  <tr key={returnItem.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm">{returnItem.Customers?.name}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
