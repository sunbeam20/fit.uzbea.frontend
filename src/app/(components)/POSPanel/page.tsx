    ...
    >
      <div className="grid grid-cols-2 gap-1">
        ...
        <button
          ...
          className="py-1 rounded-xl bg-yellow-500 hover:bg-yellow-600 text-white font-bold transition-colors flex items-center justify-center gap-2 cursor-pointer"
        >
          <Percent size={14} />
          Discount
        </button>
        ...
        <button
          onClick={handleService}
          className="py-1 rounded-xl bg-gray-500 hover:bg-gray-600 text-white font-bold transition-colors flex items-center justify-center gap-2 cursor-pointer"
        >
          <Wrench size={14} />
          Pre Order
        </button>
